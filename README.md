...
** GIT **
git@github.com:sadiposeidon/FULLSTACK.git				# Use a password-protected SSH key.
git clone https://github.com/sadiposeidon/FULLSTACK.git			# Repository-i kompüterə kopyalayir
git remote set-url origin git@github.com:sadiposeidon/FULLSTACK.git     # 
git remote -v								#

git config --global user.name "sadiposeidon"          		   	# Git user adini set edir
git config --global user.email "sadiposeidon@gmail.com"         	# Git user emailini set edir
